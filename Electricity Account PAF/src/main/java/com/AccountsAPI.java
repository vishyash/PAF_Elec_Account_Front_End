...
public class AccountsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = itemObj.insertItem(	request.getParameter("accountNumber"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = itemObj.updateItem(	paras.get("hidItemIDSave").toString(),
											...
											paras.get("accountName").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = itemObj.deleteItem(	paras.get("accountID").toString());
